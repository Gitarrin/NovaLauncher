...
namespace NovaLauncher
{
	internal class Error
	{
		...
		public static class Installer {
			...
			public static ErrorBase ExtractFailed { get; } = new ErrorBase("120-0006", "An error occurred while attempting to extract {NAME}.\n{ERROR}\n{INSTALLPATH}");
			public static ErrorBase DownloadFailed { get; } = new ErrorBase("120-0007", "An error occurred while trying to download {NAME}!\n{ERROR}\nThe installer will now close.");
